  ...
  return (
    ...
    >
      ...
      <div className="flex md:order-2">
        <DarkThemeToggle />
        <a
        href="https://github.com/jhonelalam/CIPH3R"
        target="_blank"
        rel="noopener noreferrer"
        className={`hidden md:flex mx-3 bg-gray-800 hover:bg-gray-900 py-2 px-4 transition-all duration-300 flex items-center gap-2 rounded-[9px] ${
      ...
      >
        ...
        <button
          ...
          className={`text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-bold text-center mx-3 md:mr-0 z-10 transition-all duration-300 rounded-[9px] ${
